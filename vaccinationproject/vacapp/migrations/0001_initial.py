# Generated by Django 3.2.23 on 2024-01-03 22:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replay', models.CharField(blank=True, max_length=2000, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='hospital',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vacapp.hospital'),
        ),
        migrations.AddField(
            model_name='appointment',
            name='vaccine',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vacapp.vaccine'),
        ),
    ]
